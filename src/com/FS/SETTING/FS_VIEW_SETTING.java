...
//				break;
	...
	private void pFS_RLayout_TITLE4_RLayout(View view) {
		...
		view.findViewById(R.id.pFS_RLayout_RLayout_Cycle_IButton).getLayoutParams().height = Tool.getWidth(30);
		...
		view.findViewById(R.id.pFS_RLayout_RLayout_Random_IButton).getLayoutParams().height = Tool.getWidth(30);
