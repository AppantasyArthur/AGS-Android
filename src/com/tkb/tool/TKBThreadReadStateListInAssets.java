...
public class TKBThreadReadStateListInAssets {
...
//	private static HashMap<String,SoftReference<StateListDrawable>> map = new HashMap<String,SoftReference<StateListDrawable>>();
	...
	public TKBThreadReadStateListInAssets(Context context, String resName_a,String resName_b,View view,int type){
		...
		executorService.submit(new Runnable(){
			...
			public void run() {
				...
				if(map.get(resName_a)==null||map.get(resName_a).get()==null){
					bitmapA = TKBTool.readBitMapInAssets(context, resName_a);
				...
				if(map.get(resName_b)==null||map.get(resName_b).get()==null){
					bitmapB = TKBTool.readBitMapInAssets(context, resName_b);
				...
				HandlerView handlerView = new HandlerView(TKBThreadReadStateListInAssets.this.view,states);
