...
//	}
	public static void FragmentActivity_MainAddFragment(FragmentTransaction fragmentTransaction,Fragment fragment,String Tag,int View_ID,int AnimationIn,int AnimationOut){
		fragmentTransaction.setCustomAnimations(AnimationIn, AnimationOut);
