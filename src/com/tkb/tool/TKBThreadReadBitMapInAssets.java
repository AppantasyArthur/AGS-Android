...
public class TKBThreadReadBitMapInAssets {
	...
	public TKBThreadReadBitMapInAssets(Context context, String resName,View view,int type){
		...
		executorService.submit(new Runnable(){
			...
			public void run() {
				...
				if(map.get(resName)==null||map.get(resName).get()==null){
					...
					bitmap = TKBTool.readBitMapInAssets(context, resName);					
				...
				HandlerView hview = new HandlerView(TKBThreadReadBitMapInAssets.this.view,bitmap);
