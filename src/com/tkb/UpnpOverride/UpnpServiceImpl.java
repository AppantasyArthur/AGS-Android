...
import com.tkb.UpnpOverride.ControlPointImpl;
...
public class UpnpServiceImpl implements UpnpService {
    ...
    protected final ControlPointImpl controlPointImpl;
    protected final ControlPoint controlPoint;
    protected final ControlPointProcessBar controlPointProcessBar;
    ...
    public UpnpServiceImpl(UpnpServiceConfiguration configuration, RegistryListener... registryListeners) {
        ...
        //TKB//¨ú±ocontrolPointImpl¡BcontrolPoint¡BcontrolPointProcessBar
        this.controlPointImpl = createControlPoint(protocolFactory, registry);
        this.controlPoint = controlPointImpl;
        this.controlPointProcessBar = controlPointImpl;
    ...
    protected ControlPointImpl createControlPoint(ProtocolFactory protocolFactory, Registry registry) {
    ...
    //TKB//getControlPointProcessBar
    public ControlPointProcessBar getControlPointProcessBar(){
    	return controlPointProcessBar;
    }
    //================
