...
public class FSW_WIFIAP_ListView_BaseAdapter_Phone extends BaseAdapter {
	...
	public FSW_WIFIAP_ListView_BaseAdapter_Phone(Context context){
	...
	private void basicSetChildView(ViewHandler viewHandler){
		//Tick_ImageView
		Tool.fitsViewHeight(18, viewHandler.Tick_ImageView);
		viewHandler.Tick_ImageView.getLayoutParams().width = Tool.getHeight(14);
		...
		//Lock_ImageView
		Tool.fitsViewHeight(18, viewHandler.Lock_ImageView);
		viewHandler.Lock_ImageView.getLayoutParams().width = Tool.getHeight(14);
