...
public class FSM_MENU_ListView_BaseAdapter_Phone extends BaseAdapter {
	private Context context;
	private MLog mlog = new MLog();
	private static final String TAG = "FSM_MENU_ListView_BaseAdapter_Phone";
	
	private List<String> menuList = new ArrayList<String>();
	
	private int choosedMenu = -1;
	
	public FSM_MENU_ListView_BaseAdapter_Phone(Context context){
