...
// FAM_PopupWindow
public class AGSAlarmSettingTimePickerPopupWindow extends PopupWindow {
	...
	private static final String tag = "AGSAlarmSettingTimePickerPopupWindow";
	
	private FragmentManager fragmentManager;
	public AGSAlarmSettingTimePickerPopupWindow(Context context, FragmentManager fragmentManager){
...
//		
		...
		// init value, Arthur
		String time = AGSAlarmSettingAddEditFragement.getTimeText();
		...
		for(int i = 0;i < times[0].length();i++){
			h = h * 10;
			h = h + Integer.parseInt( String.valueOf( times[0].charAt(i) ) );
		}
		...
		for(int i = 0;i < times[1].length();i++){
			m = m * 10;
			m = m + Integer.parseInt( String.valueOf( times[1].charAt(i) ) );
		}
	...
	private void setViewListner(){
		...
		this.contentView.findViewById(R.id.FSAL_PopupWindow_BackGround_RLayout).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				AGSAlarmSettingTimePickerPopupWindow.this.dismiss();	
			}
		});	
		...
		this.contentView.findViewById(R.id.FSAL_PopupWindow_Content_RLayout_RLayout_Done_Button).setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {	
				AGSAlarmSettingAddEditFragement fragment = (AGSAlarmSettingAddEditFragement)fragmentManager.findFragmentByTag("Fragment_SAlarm_EditAdd");
				//if(fragment!=null){
