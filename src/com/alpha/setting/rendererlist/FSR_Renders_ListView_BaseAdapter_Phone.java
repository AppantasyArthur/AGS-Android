...
public class FSR_Renders_ListView_BaseAdapter_Phone extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {	
		...
		if(convertView==null){
			...
			convertView.setLayoutParams(new AbsListView.LayoutParams(LayoutParams.MATCH_PARENT,TKBTool.getHeight(80)));
	...
	private void basicSetChildView(ViewHandler viewHandler){
		TKBTool.fitsViewHeight(61, viewHandler.CCell_RLayout);
		new TKBThreadReadStateListInAssets(context, "phone/setting/settings_bar_f.PNG", "phone/setting/settings_bar_n.PNG", viewHandler.CCell_RLayout, 3);
		//Name TextView
		TKBTool.fitsViewLeftMargin(5, viewHandler.Name_TextView);
		TKBTool.fitsViewTextSize(12, viewHandler.Name_TextView);
		//Image ImageView
		TKBTool.fitsViewHeight(9, viewHandler.Image_ImageView);
		viewHandler.Image_ImageView.getLayoutParams().width = TKBTool.getHeight(16);
		TKBTool.fitsViewRightMargin(19, viewHandler.Image_ImageView);
		TKBTool.fitsViewTopMargin(26, viewHandler.Image_ImageView);
		new TKBThreadReadStateListInAssets(context, "phone/playlist/down_f.png", "phone/playlist/down_n.png", viewHandler.Image_ImageView, 1);
	}
