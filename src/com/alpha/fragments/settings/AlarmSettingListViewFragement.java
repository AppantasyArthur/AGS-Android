...
import com.alpha.setting.alarm.AlarmSettingListViewListener;
...
public class AlarmSettingListViewFragement extends Fragment {
	//VIEWS
	...
	private AlarmSettingListViewListener listenerView;
	
	private static String tag = "AlarmSettingListViewFragement";
	private TKBLog mlog = new TKBLog();
	private Context context;
	private int deviceScreenSize = 0;
	private DeviceDisplay chooseDeviceDisplay;
	public AlarmSettingListViewFragement(DeviceDisplay deviceDisplay){
	...
	private void processOnCreate() {
        ...
        this.listenerView = new AlarmSettingListViewListener(this.context,this.deviceScreenSize,this.chooseDeviceDisplay);
	}
