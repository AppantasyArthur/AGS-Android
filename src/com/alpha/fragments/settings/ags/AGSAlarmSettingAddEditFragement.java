...
import com.alpha.setting.alarm.ags.AGSAlarmSettingAddEditViewListener;
...
public class AGSAlarmSettingAddEditFragement extends AGSFragment {
	...
	private AGSAlarmSettingAddEditViewListener listenerView;
	
	private static String tag = "AGSAlarmSettingAddEditFragement";
	...
	public AGSAlarmSettingAddEditFragement(DeviceDisplay deviceDisplay, Object item){
	...
	private void processOnCreate() {
        ...
        this.listenerView = new AGSAlarmSettingAddEditViewListener(this.context, this.sizeDeviceScreen, this.chooseDeviceDisplay);
        ...
        if(currentItem != null){
        	...
        	frequencyText = currentItem.getFreaquency();
        	timeText = currentItem.getTime();
        	
        	musicText = currentItem.getMusic();
        	uriText = currentItem.getUri();
        	metaDataText = currentItem.getMetaData();
	...
	private void initPhoneViewListener() {
		...
		mlog.info(tag, "initPhoneViewListener OK");
	...
	//private String[] listFrequency = new String[]{"Once","Every Monday","Every Tuesday","Every Wedesday","Every Thursday","Every Friday","Every Saturday","Every Sunday"};
