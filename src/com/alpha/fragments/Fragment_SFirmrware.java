...
public class Fragment_SFirmrware extends Fragment {
	//VIEWS
	...
	//SETTING
	private FSF_VIEW_SETTING VIEW_SETTING;
	private FSF_VIEW_LISTNER VIEW_LISTNER;
	
	private static String TAG = "Fragment_SFirmrware";
	...
	public View onCreateView(LayoutInflater inflater,ViewGroup container, Bundle savedInstanceState) {
		if(device_size==6){
			Fragment_MainView = (ViewGroup)inflater.inflate(R.layout.fragment_sfirmrware_phone, null);
			...
			Fragment_MainView = (ViewGroup)inflater.inflate(R.layout.fragment_sfirmrware_pad, null);
			Fragment_MainView.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
			PAD_findView();
			PAD_findViewListner();
		}
	...
	private void Phone_findView() {
		this.VIEW_SETTING.VIEWSET(Fragment_MainView.findViewById(R.id.pFSF_RLayout_TITLE_RLayout));
		this.VIEW_SETTING.VIEWSET(Fragment_MainView.findViewById(R.id.pFSF_RLayout_BODY_RLayout));
	...
	private void PAD_findView() {
		this.VIEW_SETTING.VIEWSET(Fragment_MainView.findViewById(R.id.FSF_RLayout_TITLE_RLayout));
		this.VIEW_SETTING.VIEWSET(Fragment_MainView.findViewById(R.id.FSF_RLayout_BODY_RLayout));
		mlog.info(TAG, "findView OK");
	}	
