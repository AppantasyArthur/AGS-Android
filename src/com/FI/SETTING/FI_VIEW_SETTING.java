...
public class FI_VIEW_SETTING {
	...
	private void pFI_RLayout_TITLE4_RLayout(View view) {
		...
		//Current_TextView
		Tool.fitsViewWidth(40, view.findViewById(R.id.pFI_RLayout_RLayout_Current_TextView));
		...
		//Total_TextView
		Tool.fitsViewWidth(40, view.findViewById(R.id.pFI_RLayout_RLayout_Total_TextView));
