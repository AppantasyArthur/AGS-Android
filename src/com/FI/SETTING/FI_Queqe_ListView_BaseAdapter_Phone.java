...
public class FI_Queqe_ListView_BaseAdapter_Phone extends BaseAdapter {
	...
	private Handler handler = new Handler(){
		...
		public void handleMessage(Message msg) {
			switch(msg.what){
			case 0:
				if(FI_Queqe_ListView_BaseAdapter_Phone.this.dataList!=null){
					FI_Queqe_ListView_BaseAdapter_Phone.this.dataList.clear();
					FI_Queqe_ListView_BaseAdapter_Phone.this.notifyDataSetChanged();
				}				
				break;
			case 1:
				if(FI_Queqe_ListView_BaseAdapter_Phone.this.dataList!=null){
					...
					FI_Queqe_ListView_BaseAdapter_Phone.this.dataList = new ArrayList<TrackDO>();
				}
				...
				for(int i = 0;i< queueList.size();i++){
					...
					FI_Queqe_ListView_BaseAdapter_Phone.this.dataList.add(queueList.get(i));
				}
				FI_Queqe_ListView_BaseAdapter_Phone.this.notifyDataSetChanged();	
				break;
			}
