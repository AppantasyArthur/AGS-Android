...
public class FAM_Save_PopupWindow extends PopupWindow {
	...
	private void Phone_CreateContentView() {
		...
		TKBTool.fitsViewHeight(26, InputName_EditText);
		TKBTool.fitsViewWidth(242, InputName_EditText);
		TKBTool.fitsViewTextSize(8, InputName_EditText);
		TKBTool.fitsViewTopMargin(5, InputName_EditText);
		new TKBThreadReadBitMapInAssets(context, "phone/pop/save_name_bar.png", InputName_EditText, 3);
	...
	private void PAD_CreateContentView() {
		...
		//InputName EditText
		InputName_EditText = (EditText)this.contentView.findViewById(R.id.FAM_Save_PopupWindow_Content_RLayout_RLayout_InputName_EditText);
		TKBTool.fitsViewHeight(40, InputName_EditText);
		TKBTool.fitsViewWidth(400, InputName_EditText);
		TKBTool.fitsViewTextSize(8, InputName_EditText);
		TKBTool.fitsViewTopMargin(10, InputName_EditText);
		new TKBThreadReadBitMapInAssets(context, "pad/pop/insert_box.png", InputName_EditText, 3);
		mlog.info(TAG, "CreateContentView");
	}
